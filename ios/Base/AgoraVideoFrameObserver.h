...
@required
- (BOOL)onCaptureVideoFrame:(int) sourceType frame:(AgoraVideoFrame *_Nonnull)videoFrame;
- (BOOL)onRenderVideoFrame:(AgoraVideoFrame *_Nonnull)videoFrame
                       uid:(NSUInteger)uid;
@optional
- (BOOL)onPreEncodeVideoFrame:(int) sourceType frame:(AgoraVideoFrame *_Nonnull)videoFrame;
